...
def main():
  ...
  file = Write.Input("Faire glisser un fichier Python -> ", Colors.red_to_yellow, interval=0.005)
  print()
  ...
  with open("antitraced.py", mode='w', encoding='utf-8') as f:
      f.write(content)

  Write.Input("Fait Chef!", Colors.red_to_yellow, interval=0.005)
  return exit()
